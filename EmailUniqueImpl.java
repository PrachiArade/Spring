...
public class EmailUniqueImpl implements ConstraintValidator<perscholas.validation.EmailUnique, String> {
    ...
    @Override
    public void initialize(perscholas.validation.EmailUnique constraintAnnotation) {
